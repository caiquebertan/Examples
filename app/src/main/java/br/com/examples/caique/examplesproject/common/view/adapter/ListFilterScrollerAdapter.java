...
public class ListFilterScrollerAdapter extends GenericFilterAdapter<GenericViewHolder, CustomItem> {

    private static final int VT_ITEM = 1;
    private final Context ctx;
    private final Listener listener;

    public ListFilterScrollerAdapter(Context ctx, Listener listener) {
        super(ctx);
        this.ctx= ctx;
