...
public class ListAdapter extends GenericAdapter<GenericViewHolder<CustomItem>, CustomItem> {

    private final Context ctx;
    private GenericViewHolder.ItemClickListener<CustomItem> listener;

    public ListAdapter(Context ctx, GenericViewHolder.ItemClickListener<CustomItem> listener) {
        this.ctx= ctx;
